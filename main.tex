...
\begin{frame}[fragile]{Добавление формул}
	...
	\begin{itemize}
		...
		\verb|$\Delta =\nabla^{2}$|: $\Delta =\nabla^{2}$.
		\item Вынесенные формулы добавляются, например с помощью двух символов доллара, либо с использованием окружения \verb|equation|, любо любым другим предпочтительным для вас способом.
	\end{itemize}
\end{frame}
